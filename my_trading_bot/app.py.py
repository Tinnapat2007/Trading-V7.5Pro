...
# =========================================================================
# ใช้การกระจายคอลัมน์แบบยืดหยุ่น เหมาะสำหรับปุ่มบนสมาร์ทโฟน
        ...
        for asset_raw in selected_assets:
            try:
                ...
                if not all_yf_data.empty:
                    ...
                    elif meta["yf_sym"] in all_yf_data.columns.get_level_values(0):
        ...
        if dashboard_summary:
            ...
            for name, data in detailed_results.items():
                with st.expander(f"🔎 เจาะลึกสัญญาณของ: {name}"):
                    ...
                    # ปรับกล่องตัวเลข Metric ให้แสดงผลสวยงามบนมือถือ ไม่ซ้อนทับกัน
