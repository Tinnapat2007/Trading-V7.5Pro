...
# Config
# ============================================================================
APP_VERSION = "v3.0 Pro Confirmation"
MAX_ASSETS = 20
...
st.caption("Data: Binance Spot, Yahoo Finance fallback, TradingView consensus, Multi-Timeframe, S/R, RR, Volume และ mini backtest")
...
if (st.session_state.run_once or st.session_state.auto_mode) and assets:
    ...
    for index, asset in enumerate(assets):
        ...
        call = build_trade_call(asset, state, tv=tv, data_source=data_source, higher_state=higher_state)
        calls.append(call)
